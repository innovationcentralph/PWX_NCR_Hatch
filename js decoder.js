function Decoder(bytes, port) {
    ...
    if (port === 2) {
        ...
        if (data[0] === 0xA1) {
            ...
            decoded.WC1= data[8] & 0x01 ? "ON" : "OFF";
            decoded.WC2= data[8] & 0x02 ? "ON" : "OFF";
        } 
            ...
            data = data.slice(1);
            decoded.PASSKEY_STAT = data[0] & 0x1? "NOT SILENT": "SILENT" ;
            data = data.slice(1);
            PASSKEY = [];
            ...
            decoded.PASSKEY_STR = String.fromCharCode(...PASSKEY);
