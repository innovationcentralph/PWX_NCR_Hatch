...
inline uint8_t devEUI[8]= {0x10,0x10,0x10,0x10,0x08,0xB1,0x2D,0x16};                           
inline uint8_t appKEY[16]= {0x8A,0xD7,0x3D,0x3D,0x3B,0x47,0xD4,0x3E,0xF5,0xB2,0xF8,0x25,0x26,0xAA,0xB1,0x11};
inline uint8_t devADDR[4]= {0xE0, 0x24, 0xA2, 0x95}; 
